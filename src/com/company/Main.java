...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("10.3 % 5 = " + 10.3F % 5);
        System.out.println("Math.random() = " + Math.random());
        System.out.println("Math.random() * 10 = " + Math.random() * 10);
        System.out.println("Math.random() * 60 = " + Math.random() * 60);
        System.out.println("Math.ceil(Math.random() * 10) = " + Math.ceil(Math.random() * 10));
        System.out.println("Math.floor(Math.random() * 10) = " + Math.floor(Math.random() * 10));
